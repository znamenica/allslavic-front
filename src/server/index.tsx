...
export const renderApp = (req: any, res: any) => {
    res.socket.on("error", (error: string) => {
    ...
    const BaseApp = () => {
        ...
        // return isPending ? <>loading</> : (
            return (<Html
                    assets={assets}
                    jsAssets={jsScriptTagsFromAssets(assets, 'client', ' defer crossorigin')}
                    cssAssets={cssLinksFromAssets(assets, 'client')}
                    title="test"
                >
    ...
    .init(
        ...
        () => {
            index
                ...
                .get('/*', handleErrors(function(req: any, res: any) {
                        renderApp(req, res);
                    }))
                    // const {html = '', redirect = ''} =
